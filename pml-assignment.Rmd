...
modFit$finalModel
```
Note the estimate error is 0.65%
...
The out of sample accuracy is 0.9933. So the out of sample error is 1 - 0.9933 = 0.67%  Comparing that to the estimate error from the model which is 0.65% The error rates are expected to be similar. 
